...
export default function SignUpForm() {
  return (
    <section className="flex min-h-screen px-4 py-16 md:py-32">
      <form
        action=""
        className="bg-muted m-auto h-fit w-full max-w-sm overflow-hidden rounded-xl border border-orange-200/50 dark:border-orange-900/50 shadow-lg shadow-orange-300/20 dark:shadow-orange-900/20 dark:[--color-muted:var(--color-slate-900)]"
      >
        <div className="bg-card -m-px rounded-xl border border-orange-200/50 dark:border-orange-900/50 p-8 pb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              type="button"
              variant="outline"
              className="border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 bg-transparent"
            >
              <svg
